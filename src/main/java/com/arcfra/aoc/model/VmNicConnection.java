...
public class VmNicConnection extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VmNicConnection aggregate_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AGGREGATE);
        return this;
    }

    public VmNicConnection aggregate_ExplictlyNonNull() {
