...
public class VmFolderConnection extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VmFolderConnection aggregate_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AGGREGATE);
        return this;
    }

    public VmFolderConnection aggregate_ExplictlyNonNull() {
