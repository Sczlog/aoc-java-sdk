...
public class GetVmSnapshotsConnectionRequestBody
    ...
    public GetVmSnapshotsConnectionRequestBody() {}
    ...
    public GetVmSnapshotsConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVmSnapshotsConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetVmSnapshotsConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVmSnapshotsConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetVmSnapshotsConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVmSnapshotsConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetVmSnapshotsConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVmSnapshotsConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetVmSnapshotsConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVmSnapshotsConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVmSnapshotsConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVmSnapshotsConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVmSnapshotsConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVmSnapshotsConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetVmSnapshotsConnectionRequestBody getVmSnapshotsConnectionRequestBody =
                (GetVmSnapshotsConnectionRequestBody) o;
        return Objects.equals(this.after, getVmSnapshotsConnectionRequestBody.after)
                && Objects.equals(this.before, getVmSnapshotsConnectionRequestBody.before)
                && Objects.equals(this.first, getVmSnapshotsConnectionRequestBody.first)
                && Objects.equals(this.last, getVmSnapshotsConnectionRequestBody.last)
                && Objects.equals(this.orderBy, getVmSnapshotsConnectionRequestBody.orderBy)
                && Objects.equals(this.skip, getVmSnapshotsConnectionRequestBody.skip)
                && Objects.equals(this.where, getVmSnapshotsConnectionRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetVmSnapshotsConnectionRequestBody {\n");
