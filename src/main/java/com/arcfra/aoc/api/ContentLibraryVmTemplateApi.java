...
public class ContentLibraryVmTemplateApi {
     ...
     */
    public okhttp3.Call exportContentLibraryVmTemplateCall(ContentLibraryVmTemplateExportParams contentLibraryVmTemplateExportParams, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call exportContentLibraryVmTemplateValidateBeforeCall(ContentLibraryVmTemplateExportParams contentLibraryVmTemplateExportParams, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentLibraryVmTemplateExportParams' is set
        if (contentLibraryVmTemplateExportParams == null) {
            throw new ApiException("Missing the required parameter 'contentLibraryVmTemplateExportParams' when calling exportContentLibraryVmTemplate(Async)");
        }
        

        okhttp3.Call localVarCall = exportContentLibraryVmTemplateCall(contentLibraryVmTemplateExportParams, _callback);
        return localVarCall;
    ...
    public List<WithTaskVmExportFile> exportContentLibraryVmTemplate(ContentLibraryVmTemplateExportParams contentLibraryVmTemplateExportParams) throws ApiException {
        ApiResponse<List<WithTaskVmExportFile>> localVarResp = exportContentLibraryVmTemplateWithHttpInfo(contentLibraryVmTemplateExportParams);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<List<WithTaskVmExportFile>> exportContentLibraryVmTemplateWithHttpInfo(ContentLibraryVmTemplateExportParams contentLibraryVmTemplateExportParams) throws ApiException {
        okhttp3.Call localVarCall = exportContentLibraryVmTemplateValidateBeforeCall(contentLibraryVmTemplateExportParams, null);
     ...
     */
    public okhttp3.Call exportContentLibraryVmTemplateAsync(ContentLibraryVmTemplateExportParams contentLibraryVmTemplateExportParams, final ApiCallback<List<WithTaskVmExportFile>> _callback) throws ApiException {

        okhttp3.Call localVarCall = exportContentLibraryVmTemplateValidateBeforeCall(contentLibraryVmTemplateExportParams, _callback);
        Type localVarReturnType = new TypeToken<List<WithTaskVmExportFile>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call importContentLibraryVmTemplateCall(List<ContentLibraryVmTemplateImportParams> contentLibraryVmTemplateImportParams, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importContentLibraryVmTemplateValidateBeforeCall(List<ContentLibraryVmTemplateImportParams> contentLibraryVmTemplateImportParams, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'contentLibraryVmTemplateImportParams' is set
        if (contentLibraryVmTemplateImportParams == null) {
            throw new ApiException("Missing the required parameter 'contentLibraryVmTemplateImportParams' when calling importContentLibraryVmTemplate(Async)");
        }
        

        okhttp3.Call localVarCall = importContentLibraryVmTemplateCall(contentLibraryVmTemplateImportParams, _callback);
        return localVarCall;
    ...
    public List<WithTaskContentLibraryVmTemplate> importContentLibraryVmTemplate(List<ContentLibraryVmTemplateImportParams> contentLibraryVmTemplateImportParams) throws ApiException {
        ApiResponse<List<WithTaskContentLibraryVmTemplate>> localVarResp = importContentLibraryVmTemplateWithHttpInfo(contentLibraryVmTemplateImportParams);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<List<WithTaskContentLibraryVmTemplate>> importContentLibraryVmTemplateWithHttpInfo(List<ContentLibraryVmTemplateImportParams> contentLibraryVmTemplateImportParams) throws ApiException {
        okhttp3.Call localVarCall = importContentLibraryVmTemplateValidateBeforeCall(contentLibraryVmTemplateImportParams, null);
        Type localVarReturnType = new TypeToken<List<WithTaskContentLibraryVmTemplate>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call importContentLibraryVmTemplateAsync(List<ContentLibraryVmTemplateImportParams> contentLibraryVmTemplateImportParams, final ApiCallback<List<WithTaskContentLibraryVmTemplate>> _callback) throws ApiException {

        okhttp3.Call localVarCall = importContentLibraryVmTemplateValidateBeforeCall(contentLibraryVmTemplateImportParams, _callback);
        Type localVarReturnType = new TypeToken<List<WithTaskContentLibraryVmTemplate>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
