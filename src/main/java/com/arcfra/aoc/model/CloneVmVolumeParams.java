...
public class CloneVmVolumeParams
    ...
    public CloneVmVolumeParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public CloneVmVolumeParams where_ExplictlyNonNull() {
    ...
    public CloneVmVolumeParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public CloneVmVolumeParams data_ExplictlyNonNull() {
