...
public class GetIscsiLunsRequestBody
    ...
    public GetIscsiLunsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetIscsiLunsRequestBody after_ExplictlyNonNull() {
    ...
    public GetIscsiLunsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetIscsiLunsRequestBody before_ExplictlyNonNull() {
    ...
    public GetIscsiLunsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetIscsiLunsRequestBody first_ExplictlyNonNull() {
    ...
    public GetIscsiLunsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetIscsiLunsRequestBody last_ExplictlyNonNull() {
    ...
    public GetIscsiLunsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetIscsiLunsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetIscsiLunsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetIscsiLunsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetIscsiLunsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetIscsiLunsRequestBody where_ExplictlyNonNull() {
