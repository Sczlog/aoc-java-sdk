...
public class VmUpdateDiskParams extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    public static final String SERIALIZED_NAME_DATA = "data";

    @SerializedName(SERIALIZED_NAME_DATA)
    private VmUpdateDiskParamsData data;
    ...
    public VmUpdateDiskParamsData getData() {
        return data;
    }
    ...
    public boolean equals(Object o) {
        ...
        VmUpdateDiskParams vmUpdateDiskParams = (VmUpdateDiskParams) o;
        return Objects.equals(this.data, vmUpdateDiskParams.data)
                && Objects.equals(this.where, vmUpdateDiskParams.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class VmUpdateDiskParams {\n");
