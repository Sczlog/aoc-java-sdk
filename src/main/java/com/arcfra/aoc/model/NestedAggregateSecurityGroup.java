...
public class NestedAggregateSecurityGroup
    ...
    public NestedAggregateSecurityGroup count_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_COUNT);
        return this;
    }

    public NestedAggregateSecurityGroup count_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        NestedAggregateSecurityGroup nestedAggregateSecurityGroup =
                (NestedAggregateSecurityGroup) o;
