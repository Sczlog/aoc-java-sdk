...
import com.arcfra.aoc.model.GpuDeviceStatus;
import com.arcfra.aoc.model.GpuDeviceUsage;
import com.arcfra.aoc.model.NestedGpuDriverInfo;
import com.arcfra.aoc.model.NestedHost;
import com.arcfra.aoc.model.NestedLabel;
import com.arcfra.aoc.model.NestedVgpuType;
...
public class VmGpuDetail {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(vgpuInstanceOnVmNum, vgpuInstanceNum, userVgpuTypeName, userVgpuTypeId, userUsage, status, name, model, mdevSupportedTypes, localId, localCreatedAt, labels, isNvidiaVfsSupported, isNvidiaVfsEnabled, isNvidiaToolsReady, id, host, entityAsyncStatus, driverInfo, description, busLocation, brand, availableVgpusNum, assignedVgpusNum);
  }
