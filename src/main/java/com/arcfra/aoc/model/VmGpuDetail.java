...
public class VmGpuDetail extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VmGpuDetail vgpuInstanceOnVmNum(Integer vgpuInstanceOnVmNum) {
    ...
    public VmGpuDetail vgpuInstanceOnVmNum_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_VGPU_INSTANCE_ON_VM_NUM);
        return this;
    }

    public VmGpuDetail vgpuInstanceOnVmNum_ExplictlyNonNull() {
    ...
    public VmGpuDetail vgpuInstanceNum(Integer vgpuInstanceNum) {
    ...
    public VmGpuDetail vgpuInstanceNum_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_VGPU_INSTANCE_NUM);
        return this;
    }

    public VmGpuDetail vgpuInstanceNum_ExplictlyNonNull() {
    ...
    public VmGpuDetail userVgpuTypeName(String userVgpuTypeName) {
    ...
    public VmGpuDetail userVgpuTypeName_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_USER_VGPU_TYPE_NAME);
        return this;
    }

    public VmGpuDetail userVgpuTypeName_ExplictlyNonNull() {
    ...
    public VmGpuDetail userVgpuTypeId(String userVgpuTypeId) {
    ...
    public VmGpuDetail userVgpuTypeId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_USER_VGPU_TYPE_ID);
        return this;
    }

    public VmGpuDetail userVgpuTypeId_ExplictlyNonNull() {
    ...
    public VmGpuDetail userUsage(GpuDeviceUsage userUsage) {
    ...
    public VmGpuDetail userUsage_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_USER_USAGE);
        return this;
    }

    public VmGpuDetail userUsage_ExplictlyNonNull() {
    ...
    public VmGpuDetail status(GpuDeviceStatus status) {
    ...
    public VmGpuDetail status_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_STATUS);
        return this;
    }

    public VmGpuDetail status_ExplictlyNonNull() {
    ...
    public VmGpuDetail name(String name) {
    ...
    public VmGpuDetail name_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_NAME);
        return this;
    }

    public VmGpuDetail name_ExplictlyNonNull() {
    ...
    public VmGpuDetail model(String model) {
    ...
    public VmGpuDetail model_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_MODEL);
        return this;
    }

    public VmGpuDetail model_ExplictlyNonNull() {
    ...
    public VmGpuDetail mdevSupportedTypes(List<NestedVgpuType> mdevSupportedTypes) {

        this.mdevSupportedTypes = mdevSupportedTypes;
        return this;
    }

    public VmGpuDetail addMdevSupportedTypesItem(NestedVgpuType mdevSupportedTypesItem) {
    ...
    public VmGpuDetail mdevSupportedTypes_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_MDEV_SUPPORTED_TYPES);
        return this;
    }

    public VmGpuDetail mdevSupportedTypes_ExplictlyNonNull() {
    ...
    public VmGpuDetail localId(String localId) {
    ...
    public VmGpuDetail localId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LOCAL_ID);
        return this;
    }

    public VmGpuDetail localId_ExplictlyNonNull() {
    ...
    public VmGpuDetail localCreatedAt(String localCreatedAt) {
    ...
    public VmGpuDetail localCreatedAt_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LOCAL_CREATED_AT);
        return this;
    }

    public VmGpuDetail localCreatedAt_ExplictlyNonNull() {
    ...
    public VmGpuDetail labels(List<NestedLabel> labels) {

        this.labels = labels;
        return this;
    }

    public VmGpuDetail addLabelsItem(NestedLabel labelsItem) {
        if (this.labels == null) {
    ...
    public VmGpuDetail labels_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LABELS);
        return this;
    }

    public VmGpuDetail labels_ExplictlyNonNull() {
    ...
    public VmGpuDetail isNvidiaVfsSupported(Boolean isNvidiaVfsSupported) {
    ...
    public VmGpuDetail isNvidiaVfsSupported_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_IS_NVIDIA_VFS_SUPPORTED);
        return this;
    }

    public VmGpuDetail isNvidiaVfsSupported_ExplictlyNonNull() {
    ...
    public VmGpuDetail isNvidiaVfsEnabled(Boolean isNvidiaVfsEnabled) {
    ...
    public VmGpuDetail isNvidiaVfsEnabled_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_IS_NVIDIA_VFS_ENABLED);
        return this;
    }

    public VmGpuDetail isNvidiaVfsEnabled_ExplictlyNonNull() {
    ...
    public VmGpuDetail isNvidiaToolsReady(Boolean isNvidiaToolsReady) {
    ...
    public VmGpuDetail isNvidiaToolsReady_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_IS_NVIDIA_TOOLS_READY);
        return this;
    }

    public VmGpuDetail isNvidiaToolsReady_ExplictlyNonNull() {
    ...
    public VmGpuDetail id(String id) {
    ...
    public VmGpuDetail id_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ID);
        return this;
    }

    public VmGpuDetail id_ExplictlyNonNull() {
    ...
    public VmGpuDetail host(NestedHost host) {
    ...
    public VmGpuDetail host_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_HOST);
        return this;
    }

    public VmGpuDetail host_ExplictlyNonNull() {
    ...
    public VmGpuDetail entityAsyncStatus(EntityAsyncStatus entityAsyncStatus) {
    ...
    public VmGpuDetail entityAsyncStatus_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ENTITY_ASYNC_STATUS);
        return this;
    }

    public VmGpuDetail entityAsyncStatus_ExplictlyNonNull() {
    ...
    public VmGpuDetail driverInfo(NestedGpuDriverInfo driverInfo) {
    ...
    public VmGpuDetail driverInfo_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DRIVER_INFO);
        return this;
    }

    public VmGpuDetail driverInfo_ExplictlyNonNull() {
    ...
    public VmGpuDetail description(String description) {
    ...
    public VmGpuDetail description_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DESCRIPTION);
        return this;
    }

    public VmGpuDetail description_ExplictlyNonNull() {
    ...
    public VmGpuDetail busLocation(String busLocation) {
    ...
    public VmGpuDetail busLocation_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BUS_LOCATION);
        return this;
    }

    public VmGpuDetail busLocation_ExplictlyNonNull() {
    ...
    public VmGpuDetail brand(String brand) {
    ...
    public VmGpuDetail brand_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BRAND);
        return this;
    }

    public VmGpuDetail brand_ExplictlyNonNull() {
    ...
    public VmGpuDetail availableVgpusNum(Integer availableVgpusNum) {
    ...
    public VmGpuDetail availableVgpusNum_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AVAILABLE_VGPUS_NUM);
        return this;
    }

    public VmGpuDetail availableVgpusNum_ExplictlyNonNull() {
    ...
    public VmGpuDetail assignedVgpusNum(Integer assignedVgpusNum) {
    ...
    public VmGpuDetail assignedVgpusNum_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ASSIGNED_VGPUS_NUM);
        return this;
    }

    public VmGpuDetail assignedVgpusNum_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        VmGpuDetail vmGpuDetail = (VmGpuDetail) o;
        return Objects.equals(this.vgpuInstanceOnVmNum, vmGpuDetail.vgpuInstanceOnVmNum)
                && Objects.equals(this.vgpuInstanceNum, vmGpuDetail.vgpuInstanceNum)
                && Objects.equals(this.userVgpuTypeName, vmGpuDetail.userVgpuTypeName)
                && Objects.equals(this.userVgpuTypeId, vmGpuDetail.userVgpuTypeId)
                && Objects.equals(this.userUsage, vmGpuDetail.userUsage)
                && Objects.equals(this.status, vmGpuDetail.status)
                && Objects.equals(this.name, vmGpuDetail.name)
                && Objects.equals(this.model, vmGpuDetail.model)
                && Objects.equals(this.mdevSupportedTypes, vmGpuDetail.mdevSupportedTypes)
                && Objects.equals(this.localId, vmGpuDetail.localId)
                && Objects.equals(this.localCreatedAt, vmGpuDetail.localCreatedAt)
                && Objects.equals(this.labels, vmGpuDetail.labels)
                && Objects.equals(this.isNvidiaVfsSupported, vmGpuDetail.isNvidiaVfsSupported)
                && Objects.equals(this.isNvidiaVfsEnabled, vmGpuDetail.isNvidiaVfsEnabled)
                && Objects.equals(this.isNvidiaToolsReady, vmGpuDetail.isNvidiaToolsReady)
                && Objects.equals(this.id, vmGpuDetail.id)
                && Objects.equals(this.host, vmGpuDetail.host)
                && Objects.equals(this.entityAsyncStatus, vmGpuDetail.entityAsyncStatus)
                && Objects.equals(this.driverInfo, vmGpuDetail.driverInfo)
                && Objects.equals(this.description, vmGpuDetail.description)
                && Objects.equals(this.busLocation, vmGpuDetail.busLocation)
                && Objects.equals(this.brand, vmGpuDetail.brand)
                && Objects.equals(this.availableVgpusNum, vmGpuDetail.availableVgpusNum)
                && Objects.equals(this.assignedVgpusNum, vmGpuDetail.assignedVgpusNum);
    }
