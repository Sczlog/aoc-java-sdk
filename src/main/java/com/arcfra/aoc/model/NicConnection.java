...
public class NicConnection extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public NicConnection aggregate_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AGGREGATE);
        return this;
    }

    public NicConnection aggregate_ExplictlyNonNull() {
