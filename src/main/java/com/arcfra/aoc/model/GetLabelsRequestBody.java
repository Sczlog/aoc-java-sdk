...
public class GetLabelsRequestBody
    ...
    public GetLabelsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetLabelsRequestBody after_ExplictlyNonNull() {
    ...
    public GetLabelsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetLabelsRequestBody before_ExplictlyNonNull() {
    ...
    public GetLabelsRequestBody first(Integer first) {
    ...
    public GetLabelsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetLabelsRequestBody first_ExplictlyNonNull() {
    ...
    public GetLabelsRequestBody last(Integer last) {
    ...
    public GetLabelsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetLabelsRequestBody last_ExplictlyNonNull() {
    ...
    public GetLabelsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetLabelsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetLabelsRequestBody skip(Integer skip) {
    ...
    public GetLabelsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetLabelsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetLabelsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetLabelsRequestBody where_ExplictlyNonNull() {
