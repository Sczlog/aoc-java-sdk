...
public class GetElfStoragePoliciesConnectionRequestBody
    ...
    public GetElfStoragePoliciesConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetElfStoragePoliciesConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetElfStoragePoliciesConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetElfStoragePoliciesConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetElfStoragePoliciesConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetElfStoragePoliciesConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetElfStoragePoliciesConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetElfStoragePoliciesConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetElfStoragePoliciesConnectionRequestBody orderBy(
            ElfStoragePolicyOrderByInput orderBy) {
    ...
    public GetElfStoragePoliciesConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetElfStoragePoliciesConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetElfStoragePoliciesConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetElfStoragePoliciesConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetElfStoragePoliciesConnectionRequestBody getElfStoragePoliciesConnectionRequestBody =
                (GetElfStoragePoliciesConnectionRequestBody) o;
