...
public class VmRemoveDiskParams extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    public static final String SERIALIZED_NAME_DATA = "data";

    @SerializedName(SERIALIZED_NAME_DATA)
    private VmRemoveDiskParamsData data;
    ...
    public VmRemoveDiskParamsData getData() {
        return data;
    }
    ...
    public boolean equals(Object o) {
        ...
        VmRemoveDiskParams vmRemoveDiskParams = (VmRemoveDiskParams) o;
        return Objects.equals(this.data, vmRemoveDiskParams.data)
                && Objects.equals(this.where, vmRemoveDiskParams.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class VmRemoveDiskParams {\n");
