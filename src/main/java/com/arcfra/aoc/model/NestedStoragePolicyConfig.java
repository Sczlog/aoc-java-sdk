...
public class NestedStoragePolicyConfig
    ...
    public NestedStoragePolicyConfig ecK(Integer ecK) {
    ...
    public NestedStoragePolicyConfig ecK_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_EC_K);
        return this;
    }

    public NestedStoragePolicyConfig ecK_ExplictlyNonNull() {
    ...
    public NestedStoragePolicyConfig ecM(Integer ecM) {
    ...
    public NestedStoragePolicyConfig ecM_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_EC_M);
        return this;
    }

    public NestedStoragePolicyConfig ecM_ExplictlyNonNull() {
    ...
    public NestedStoragePolicyConfig resiliencyType(ResiliencyType resiliencyType) {
    ...
    public NestedStoragePolicyConfig resiliencyType_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_RESILIENCY_TYPE);
        return this;
    }

    public NestedStoragePolicyConfig resiliencyType_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.ecK, nestedStoragePolicyConfig.ecK)
                && Objects.equals(this.ecM, nestedStoragePolicyConfig.ecM)
                && Objects.equals(this.replicaNum, nestedStoragePolicyConfig.replicaNum)
                && Objects.equals(this.resiliencyType, nestedStoragePolicyConfig.resiliencyType)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(ecK, ecM, replicaNum, resiliencyType, thinProvision);
    }
