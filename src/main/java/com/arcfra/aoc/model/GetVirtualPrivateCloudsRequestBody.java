...
public class GetVirtualPrivateCloudsRequestBody
    ...
    public GetVirtualPrivateCloudsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVirtualPrivateCloudsRequestBody after_ExplictlyNonNull() {
    ...
    public GetVirtualPrivateCloudsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVirtualPrivateCloudsRequestBody before_ExplictlyNonNull() {
    ...
    public GetVirtualPrivateCloudsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVirtualPrivateCloudsRequestBody first_ExplictlyNonNull() {
    ...
    public GetVirtualPrivateCloudsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVirtualPrivateCloudsRequestBody last_ExplictlyNonNull() {
    ...
    public GetVirtualPrivateCloudsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVirtualPrivateCloudsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVirtualPrivateCloudsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVirtualPrivateCloudsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVirtualPrivateCloudsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVirtualPrivateCloudsRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetVirtualPrivateCloudsRequestBody getVirtualPrivateCloudsRequestBody =
                (GetVirtualPrivateCloudsRequestBody) o;
