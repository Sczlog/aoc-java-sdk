...
public class EverouteLicenseConnection
    ...
    public EverouteLicenseConnection() {}
    ...
    public EverouteLicenseConnection aggregate_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AGGREGATE);
        return this;
    }

    public EverouteLicenseConnection aggregate_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        EverouteLicenseConnection everouteLicenseConnection = (EverouteLicenseConnection) o;
        return Objects.equals(this.aggregate, everouteLicenseConnection.aggregate);
    }
    ...
    public String toString() {
        ...
        sb.append("class EverouteLicenseConnection {\n");
