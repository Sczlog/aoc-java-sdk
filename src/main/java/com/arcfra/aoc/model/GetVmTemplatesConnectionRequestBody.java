...
public class GetVmTemplatesConnectionRequestBody
    ...
    public GetVmTemplatesConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVmTemplatesConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetVmTemplatesConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVmTemplatesConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetVmTemplatesConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVmTemplatesConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetVmTemplatesConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVmTemplatesConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetVmTemplatesConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVmTemplatesConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVmTemplatesConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVmTemplatesConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVmTemplatesConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVmTemplatesConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetVmTemplatesConnectionRequestBody getVmTemplatesConnectionRequestBody =
                (GetVmTemplatesConnectionRequestBody) o;
