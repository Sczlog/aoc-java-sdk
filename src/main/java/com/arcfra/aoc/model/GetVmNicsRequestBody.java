...
public class GetVmNicsRequestBody
    ...
    public GetVmNicsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVmNicsRequestBody after_ExplictlyNonNull() {
    ...
    public GetVmNicsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVmNicsRequestBody before_ExplictlyNonNull() {
    ...
    public GetVmNicsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVmNicsRequestBody first_ExplictlyNonNull() {
    ...
    public GetVmNicsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVmNicsRequestBody last_ExplictlyNonNull() {
    ...
    public GetVmNicsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVmNicsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVmNicsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVmNicsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVmNicsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVmNicsRequestBody where_ExplictlyNonNull() {
