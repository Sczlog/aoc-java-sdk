...
import com.arcfra.aoc.model.MountNewCreateDisksParamsVmVolume;
...
public class MountNewCreateDisksParams {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(maxBandwidthPolicy, maxBandwidthUnit, maxBandwidth, maxIopsPolicy, maxIops, vmVolume, index, key, bus, boot);
  }
