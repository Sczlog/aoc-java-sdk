...
public class GetUsersRequestBody
    ...
    public GetUsersRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetUsersRequestBody after_ExplictlyNonNull() {
    ...
    public GetUsersRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetUsersRequestBody before_ExplictlyNonNull() {
    ...
    public GetUsersRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetUsersRequestBody first_ExplictlyNonNull() {
    ...
    public GetUsersRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetUsersRequestBody last_ExplictlyNonNull() {
    ...
    public GetUsersRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetUsersRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetUsersRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetUsersRequestBody skip_ExplictlyNonNull() {
    ...
    public GetUsersRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetUsersRequestBody where_ExplictlyNonNull() {
