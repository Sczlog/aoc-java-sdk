...
public class VmAddFolderParams extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VmAddFolderParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public VmAddFolderParams data_ExplictlyNonNull() {
    ...
    public VmAddFolderParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public VmAddFolderParams where_ExplictlyNonNull() {
