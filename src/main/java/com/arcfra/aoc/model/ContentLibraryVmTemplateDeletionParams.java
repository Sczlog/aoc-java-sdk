...
public class ContentLibraryVmTemplateDeletionParams
    ...
    public ContentLibraryVmTemplateDeletionParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public ContentLibraryVmTemplateDeletionParams where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        ContentLibraryVmTemplateDeletionParams contentLibraryVmTemplateDeletionParams =
                (ContentLibraryVmTemplateDeletionParams) o;
