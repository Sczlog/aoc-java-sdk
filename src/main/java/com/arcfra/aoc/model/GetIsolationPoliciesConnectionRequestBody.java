...
public class GetIsolationPoliciesConnectionRequestBody
    ...
    public GetIsolationPoliciesConnectionRequestBody() {}
    ...
    public GetIsolationPoliciesConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetIsolationPoliciesConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetIsolationPoliciesConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetIsolationPoliciesConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetIsolationPoliciesConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetIsolationPoliciesConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetIsolationPoliciesConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetIsolationPoliciesConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetIsolationPoliciesConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetIsolationPoliciesConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetIsolationPoliciesConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetIsolationPoliciesConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetIsolationPoliciesConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetIsolationPoliciesConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetIsolationPoliciesConnectionRequestBody getIsolationPoliciesConnectionRequestBody =
                (GetIsolationPoliciesConnectionRequestBody) o;
