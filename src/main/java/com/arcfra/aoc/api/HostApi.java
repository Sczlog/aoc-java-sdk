...
public class HostApi {
     ...
     * </table>
     */
    public okhttp3.Call getHostsCall(
            GetHostsRequestBody getHostsRequestBody, final ApiCallback _callback)
            throws ApiException {
    ...
    private okhttp3.Call getHostsValidateBeforeCall(
            GetHostsRequestBody getHostsRequestBody, final ApiCallback _callback)
            throws ApiException {
        ...
        if (getHostsRequestBody == null) {
            throw new ApiException(
                    "Missing the required parameter 'getHostsRequestBody' when calling"
                            + " getHosts(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<List<Host>> getHostsWithHttpInfo(GetHostsRequestBody getHostsRequestBody)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getHostsAsync(
            GetHostsRequestBody getHostsRequestBody, final ApiCallback<List<Host>> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getHostsConnectionCall(
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getHostsConnectionValidateBeforeCall(
            GetHostsConnectionRequestBody getHostsConnectionRequestBody,
            final ApiCallback _callback)
            throws ApiException {
        ...
        if (getHostsConnectionRequestBody == null) {
            throw new ApiException(
                    "Missing the required parameter 'getHostsConnectionRequestBody' when calling"
                            + " getHostsConnection(Async)");
        }

        okhttp3.Call localVarCall =
                getHostsConnectionCall(getHostsConnectionRequestBody, _callback);
        return localVarCall;
    }
     ...
     * </table>
     */
    public HostConnection getHostsConnection(
            GetHostsConnectionRequestBody getHostsConnectionRequestBody) throws ApiException {
        ApiResponse<HostConnection> localVarResp =
                getHostsConnectionWithHttpInfo(getHostsConnectionRequestBody);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<HostConnection> getHostsConnectionWithHttpInfo(
            GetHostsConnectionRequestBody getHostsConnectionRequestBody) throws ApiException {
        okhttp3.Call localVarCall =
                getHostsConnectionValidateBeforeCall(getHostsConnectionRequestBody, null);
     ...
     * </table>
     */
    public okhttp3.Call getHostsConnectionAsync(
            GetHostsConnectionRequestBody getHostsConnectionRequestBody,
            final ApiCallback<HostConnection> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                getHostsConnectionValidateBeforeCall(getHostsConnectionRequestBody, _callback);
        Type localVarReturnType = new TypeToken<HostConnection>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
