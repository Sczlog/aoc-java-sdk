...
public class SecurityGroupUpdateBody
    ...
    public SecurityGroupUpdateBody data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public SecurityGroupUpdateBody data_ExplictlyNonNull() {
    ...
    public SecurityGroupUpdateBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public SecurityGroupUpdateBody where_ExplictlyNonNull() {
