...
public class GetVmsConnectionRequestBody
    ...
    public GetVmsConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVmsConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetVmsConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVmsConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetVmsConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVmsConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetVmsConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVmsConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetVmsConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVmsConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVmsConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVmsConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVmsConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVmsConnectionRequestBody where_ExplictlyNonNull() {
