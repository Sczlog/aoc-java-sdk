...
public class VmOperatePciNicParams
    ...
    public VmOperatePciNicParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public VmOperatePciNicParams data_ExplictlyNonNull() {
    ...
    public VmOperatePciNicParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public VmOperatePciNicParams where_ExplictlyNonNull() {
