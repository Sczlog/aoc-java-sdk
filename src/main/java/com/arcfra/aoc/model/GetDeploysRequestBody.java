...
public class GetDeploysRequestBody
    ...
    private DeployOrderByInput orderBy;
    ...
    public GetDeploysRequestBody() {}

    public GetDeploysRequestBody after(String after) {
    ...
    public GetDeploysRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetDeploysRequestBody after_ExplictlyNonNull() {
    ...
    public GetDeploysRequestBody before(String before) {
    ...
    public GetDeploysRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetDeploysRequestBody before_ExplictlyNonNull() {
    ...
    public GetDeploysRequestBody first(Integer first) {
    ...
    public GetDeploysRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetDeploysRequestBody first_ExplictlyNonNull() {
    ...
    public GetDeploysRequestBody last(Integer last) {
    ...
    public GetDeploysRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetDeploysRequestBody last_ExplictlyNonNull() {
    ...
    public GetDeploysRequestBody orderBy(DeployOrderByInput orderBy) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(value = "")
    public DeployOrderByInput getOrderBy() {
        return orderBy;
    }

    public void setOrderBy(DeployOrderByInput orderBy) {
        this.orderBy = orderBy;
    }

    public GetDeploysRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetDeploysRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetDeploysRequestBody skip(Integer skip) {
    ...
    public GetDeploysRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetDeploysRequestBody skip_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetDeploysRequestBody getDeploysRequestBody = (GetDeploysRequestBody) o;
        return Objects.equals(this.after, getDeploysRequestBody.after)
                && Objects.equals(this.before, getDeploysRequestBody.before)
                && Objects.equals(this.first, getDeploysRequestBody.first)
                && Objects.equals(this.last, getDeploysRequestBody.last)
                && Objects.equals(this.orderBy, getDeploysRequestBody.orderBy)
                && Objects.equals(this.skip, getDeploysRequestBody.skip);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetDeploysRequestBody {\n");
