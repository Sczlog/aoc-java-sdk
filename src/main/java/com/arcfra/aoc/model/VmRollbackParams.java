...
public class VmRollbackParams extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VmRollbackParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public VmRollbackParams data_ExplictlyNonNull() {
    ...
    public VmRollbackParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public VmRollbackParams where_ExplictlyNonNull() {
