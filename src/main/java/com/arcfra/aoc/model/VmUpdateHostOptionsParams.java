...
public class VmUpdateHostOptionsParams
    ...
    public VmUpdateHostOptionsParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public VmUpdateHostOptionsParams data_ExplictlyNonNull() {
    ...
    public VmUpdateHostOptionsParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public VmUpdateHostOptionsParams where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        VmUpdateHostOptionsParams vmUpdateHostOptionsParams = (VmUpdateHostOptionsParams) o;
        return Objects.equals(this.data, vmUpdateHostOptionsParams.data)
                && Objects.equals(this.where, vmUpdateHostOptionsParams.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class VmUpdateHostOptionsParams {\n");
