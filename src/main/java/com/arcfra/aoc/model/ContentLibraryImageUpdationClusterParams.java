...
public class ContentLibraryImageUpdationClusterParams
    ...
    public ContentLibraryImageUpdationClusterParams data(
            ContentLibraryImageUpdationClusterParamsData data) {
    ...
    public ContentLibraryImageUpdationClusterParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public ContentLibraryImageUpdationClusterParams data_ExplictlyNonNull() {
    ...
    public ContentLibraryImageUpdationClusterParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public ContentLibraryImageUpdationClusterParams where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        ContentLibraryImageUpdationClusterParams contentLibraryImageUpdationClusterParams =
                (ContentLibraryImageUpdationClusterParams) o;
