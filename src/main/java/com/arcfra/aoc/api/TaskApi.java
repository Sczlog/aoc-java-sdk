...
public class TaskApi {
     ...
     * </table>
     */
    public okhttp3.Call getTasksCall(
            GetTasksRequestBody getTasksRequestBody, final ApiCallback _callback)
            throws ApiException {
    ...
    private okhttp3.Call getTasksValidateBeforeCall(
            GetTasksRequestBody getTasksRequestBody, final ApiCallback _callback)
            throws ApiException {
        ...
        if (getTasksRequestBody == null) {
            throw new ApiException(
                    "Missing the required parameter 'getTasksRequestBody' when calling"
                            + " getTasks(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<List<Task>> getTasksWithHttpInfo(GetTasksRequestBody getTasksRequestBody)
            throws ApiException {
    ...
    public okhttp3.Call getTasksAsync(
            GetTasksRequestBody getTasksRequestBody, final ApiCallback<List<Task>> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getTasksConnectionCall(
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTasksConnectionValidateBeforeCall(
            GetTasksConnectionRequestBody getTasksConnectionRequestBody,
            final ApiCallback _callback)
            throws ApiException {
        ...
        if (getTasksConnectionRequestBody == null) {
            throw new ApiException(
                    "Missing the required parameter 'getTasksConnectionRequestBody' when calling"
                            + " getTasksConnection(Async)");
        }

        okhttp3.Call localVarCall =
                getTasksConnectionCall(getTasksConnectionRequestBody, _callback);
        return localVarCall;
    }
     ...
     * </table>
     */
    public TaskConnection getTasksConnection(
            GetTasksConnectionRequestBody getTasksConnectionRequestBody) throws ApiException {
        ApiResponse<TaskConnection> localVarResp =
                getTasksConnectionWithHttpInfo(getTasksConnectionRequestBody);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<TaskConnection> getTasksConnectionWithHttpInfo(
            GetTasksConnectionRequestBody getTasksConnectionRequestBody) throws ApiException {
        okhttp3.Call localVarCall =
                getTasksConnectionValidateBeforeCall(getTasksConnectionRequestBody, null);
     ...
     * </table>
     */
    public okhttp3.Call getTasksConnectionAsync(
            GetTasksConnectionRequestBody getTasksConnectionRequestBody,
            final ApiCallback<TaskConnection> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                getTasksConnectionValidateBeforeCall(getTasksConnectionRequestBody, _callback);
        Type localVarReturnType = new TypeToken<TaskConnection>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
