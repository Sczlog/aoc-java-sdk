...
public class GetDatacentersRequestBody
    ...
    private DatacenterOrderByInput orderBy;
    ...
    public GetDatacentersRequestBody after(String after) {
    ...
    public GetDatacentersRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetDatacentersRequestBody after_ExplictlyNonNull() {
    ...
    public GetDatacentersRequestBody before(String before) {
    ...
    public GetDatacentersRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetDatacentersRequestBody before_ExplictlyNonNull() {
    ...
    public GetDatacentersRequestBody first(Integer first) {
    ...
    public GetDatacentersRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetDatacentersRequestBody first_ExplictlyNonNull() {
    ...
    public GetDatacentersRequestBody last(Integer last) {
    ...
    public GetDatacentersRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetDatacentersRequestBody last_ExplictlyNonNull() {
    ...
    public GetDatacentersRequestBody orderBy(DatacenterOrderByInput orderBy) {
    ...
    public GetDatacentersRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetDatacentersRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetDatacentersRequestBody skip(Integer skip) {
    ...
    public GetDatacentersRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetDatacentersRequestBody skip_ExplictlyNonNull() {
    ...
    public GetDatacentersRequestBody where(DatacenterWhereInput where) {
    ...
    public GetDatacentersRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetDatacentersRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetDatacentersRequestBody getDatacentersRequestBody = (GetDatacentersRequestBody) o;
        return Objects.equals(this.after, getDatacentersRequestBody.after)
                && Objects.equals(this.before, getDatacentersRequestBody.before)
                && Objects.equals(this.first, getDatacentersRequestBody.first)
                && Objects.equals(this.last, getDatacentersRequestBody.last)
                && Objects.equals(this.orderBy, getDatacentersRequestBody.orderBy)
                && Objects.equals(this.skip, getDatacentersRequestBody.skip)
                && Objects.equals(this.where, getDatacentersRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetDatacentersRequestBody {\n");
