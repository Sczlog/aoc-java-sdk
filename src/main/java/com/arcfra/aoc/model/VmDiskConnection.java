...
public class VmDiskConnection extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VmDiskConnection aggregate_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AGGREGATE);
        return this;
    }

    public VmDiskConnection aggregate_ExplictlyNonNull() {
