...
public class GetVmsRequestBody extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public GetVmsRequestBody() {}

    public GetVmsRequestBody after(String after) {
    ...
    public GetVmsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVmsRequestBody after_ExplictlyNonNull() {
    ...
    public GetVmsRequestBody before(String before) {
    ...
    public GetVmsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVmsRequestBody before_ExplictlyNonNull() {
    ...
    public GetVmsRequestBody first(Integer first) {
    ...
    public GetVmsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVmsRequestBody first_ExplictlyNonNull() {
    ...
    public GetVmsRequestBody last(Integer last) {
    ...
    public GetVmsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVmsRequestBody last_ExplictlyNonNull() {
    ...
    public GetVmsRequestBody orderBy(VmOrderByInput orderBy) {
    ...
    public GetVmsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVmsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVmsRequestBody skip(Integer skip) {
    ...
    public GetVmsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVmsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVmsRequestBody where(VmWhereInput where) {
    ...
    public GetVmsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVmsRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetVmsRequestBody getVmsRequestBody = (GetVmsRequestBody) o;
        return Objects.equals(this.after, getVmsRequestBody.after)
                && Objects.equals(this.before, getVmsRequestBody.before)
                && Objects.equals(this.first, getVmsRequestBody.first)
                && Objects.equals(this.last, getVmsRequestBody.last)
                && Objects.equals(this.orderBy, getVmsRequestBody.orderBy)
                && Objects.equals(this.skip, getVmsRequestBody.skip)
                && Objects.equals(this.where, getVmsRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetVmsRequestBody {\n");
