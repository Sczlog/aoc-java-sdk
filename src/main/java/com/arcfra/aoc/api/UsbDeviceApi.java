...
public class UsbDeviceApi {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUsbDevices_0ValidateBeforeCall(GetUsbDevicesRequestBody getUsbDevicesRequestBody, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'getUsbDevicesRequestBody' is set
        if (getUsbDevicesRequestBody == null) {
            throw new ApiException("Missing the required parameter 'getUsbDevicesRequestBody' when calling getUsbDevices_0(Async)");
        }
    ...
    public List<UsbDevice> getUsbDevices_0(GetUsbDevicesRequestBody getUsbDevicesRequestBody) throws ApiException {
        ApiResponse<List<UsbDevice>> localVarResp = getUsbDevices_0WithHttpInfo(getUsbDevicesRequestBody);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<List<UsbDevice>> getUsbDevices_0WithHttpInfo(GetUsbDevicesRequestBody getUsbDevicesRequestBody) throws ApiException {
        okhttp3.Call localVarCall = getUsbDevices_0ValidateBeforeCall(getUsbDevicesRequestBody, null);
        Type localVarReturnType = new TypeToken<List<UsbDevice>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call getUsbDevices_0Async(GetUsbDevicesRequestBody getUsbDevicesRequestBody, final ApiCallback<List<UsbDevice>> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUsbDevices_0ValidateBeforeCall(getUsbDevicesRequestBody, _callback);
        Type localVarReturnType = new TypeToken<List<UsbDevice>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
