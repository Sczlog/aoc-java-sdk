...
public class ExportVmVolumeParams
    ...
    public ExportVmVolumeParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public ExportVmVolumeParams data_ExplictlyNonNull() {
    ...
    public ExportVmVolumeParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public ExportVmVolumeParams where_ExplictlyNonNull() {
