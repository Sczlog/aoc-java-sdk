...
public class GetDatacentersConnectionRequestBody
    ...
    public GetDatacentersConnectionRequestBody() {}
    ...
    public GetDatacentersConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetDatacentersConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetDatacentersConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetDatacentersConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetDatacentersConnectionRequestBody first(Integer first) {
    ...
    public GetDatacentersConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetDatacentersConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetDatacentersConnectionRequestBody last(Integer last) {
    ...
    public GetDatacentersConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetDatacentersConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetDatacentersConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetDatacentersConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetDatacentersConnectionRequestBody skip(Integer skip) {
    ...
    public GetDatacentersConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetDatacentersConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetDatacentersConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetDatacentersConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetDatacentersConnectionRequestBody getDatacentersConnectionRequestBody =
                (GetDatacentersConnectionRequestBody) o;
        return Objects.equals(this.after, getDatacentersConnectionRequestBody.after)
                && Objects.equals(this.before, getDatacentersConnectionRequestBody.before)
                && Objects.equals(this.first, getDatacentersConnectionRequestBody.first)
                && Objects.equals(this.last, getDatacentersConnectionRequestBody.last)
                && Objects.equals(this.orderBy, getDatacentersConnectionRequestBody.orderBy)
                && Objects.equals(this.skip, getDatacentersConnectionRequestBody.skip)
                && Objects.equals(this.where, getDatacentersConnectionRequestBody.where);
    }
