...
public class GetGpuDevicesConnectionRequestBody
    ...
    public GetGpuDevicesConnectionRequestBody() {}
    ...
    public GetGpuDevicesConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetGpuDevicesConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetGpuDevicesConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetGpuDevicesConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetGpuDevicesConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetGpuDevicesConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetGpuDevicesConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetGpuDevicesConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetGpuDevicesConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetGpuDevicesConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetGpuDevicesConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetGpuDevicesConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetGpuDevicesConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetGpuDevicesConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetGpuDevicesConnectionRequestBody getGpuDevicesConnectionRequestBody =
                (GetGpuDevicesConnectionRequestBody) o;
        return Objects.equals(this.after, getGpuDevicesConnectionRequestBody.after)
                && Objects.equals(this.before, getGpuDevicesConnectionRequestBody.before)
                && Objects.equals(this.first, getGpuDevicesConnectionRequestBody.first)
                && Objects.equals(this.last, getGpuDevicesConnectionRequestBody.last)
                && Objects.equals(this.orderBy, getGpuDevicesConnectionRequestBody.orderBy)
                && Objects.equals(this.skip, getGpuDevicesConnectionRequestBody.skip)
                && Objects.equals(this.where, getGpuDevicesConnectionRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetGpuDevicesConnectionRequestBody {\n");
