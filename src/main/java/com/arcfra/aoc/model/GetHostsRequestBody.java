...
public class GetHostsRequestBody
    ...
    public GetHostsRequestBody() {}

    public GetHostsRequestBody after(String after) {
    ...
    public GetHostsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetHostsRequestBody after_ExplictlyNonNull() {
    ...
    public GetHostsRequestBody before(String before) {
    ...
    public GetHostsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetHostsRequestBody before_ExplictlyNonNull() {
    ...
    public GetHostsRequestBody first(Integer first) {
    ...
    public GetHostsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetHostsRequestBody first_ExplictlyNonNull() {
    ...
    public GetHostsRequestBody last(Integer last) {
    ...
    public GetHostsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetHostsRequestBody last_ExplictlyNonNull() {
    ...
    public GetHostsRequestBody orderBy(HostOrderByInput orderBy) {
    ...
    public GetHostsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetHostsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetHostsRequestBody skip(Integer skip) {
    ...
    public GetHostsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetHostsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetHostsRequestBody where(HostWhereInput where) {
    ...
    public GetHostsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetHostsRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetHostsRequestBody getHostsRequestBody = (GetHostsRequestBody) o;
        return Objects.equals(this.after, getHostsRequestBody.after)
                && Objects.equals(this.before, getHostsRequestBody.before)
                && Objects.equals(this.first, getHostsRequestBody.first)
                && Objects.equals(this.last, getHostsRequestBody.last)
                && Objects.equals(this.orderBy, getHostsRequestBody.orderBy)
                && Objects.equals(this.skip, getHostsRequestBody.skip)
                && Objects.equals(this.where, getHostsRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetHostsRequestBody {\n");
