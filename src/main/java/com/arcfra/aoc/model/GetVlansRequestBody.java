...
public class GetVlansRequestBody
    ...
    public GetVlansRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVlansRequestBody after_ExplictlyNonNull() {
    ...
    public GetVlansRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVlansRequestBody before_ExplictlyNonNull() {
    ...
    public GetVlansRequestBody first(Integer first) {
    ...
    public GetVlansRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVlansRequestBody first_ExplictlyNonNull() {
    ...
    public GetVlansRequestBody last(Integer last) {
    ...
    public GetVlansRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVlansRequestBody last_ExplictlyNonNull() {
    ...
    public GetVlansRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVlansRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVlansRequestBody skip(Integer skip) {
    ...
    public GetVlansRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVlansRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVlansRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVlansRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.after, getVlansRequestBody.after)
                && Objects.equals(this.before, getVlansRequestBody.before)
                && Objects.equals(this.first, getVlansRequestBody.first)
                && Objects.equals(this.last, getVlansRequestBody.last)
                && Objects.equals(this.orderBy, getVlansRequestBody.orderBy)
                && Objects.equals(this.skip, getVlansRequestBody.skip)
                && Objects.equals(this.where, getVlansRequestBody.where);
    }
