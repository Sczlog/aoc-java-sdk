...
public class GetVdsesRequestBody
    ...
    public GetVdsesRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVdsesRequestBody after_ExplictlyNonNull() {
    ...
    public GetVdsesRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVdsesRequestBody before_ExplictlyNonNull() {
    ...
    public GetVdsesRequestBody first(Integer first) {
    ...
    public GetVdsesRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVdsesRequestBody first_ExplictlyNonNull() {
    ...
    public GetVdsesRequestBody last(Integer last) {
    ...
    public GetVdsesRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVdsesRequestBody last_ExplictlyNonNull() {
    ...
    public GetVdsesRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVdsesRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVdsesRequestBody skip(Integer skip) {
    ...
    public GetVdsesRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVdsesRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVdsesRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVdsesRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.after, getVdsesRequestBody.after)
                && Objects.equals(this.before, getVdsesRequestBody.before)
                && Objects.equals(this.first, getVdsesRequestBody.first)
                && Objects.equals(this.last, getVdsesRequestBody.last)
                && Objects.equals(this.orderBy, getVdsesRequestBody.orderBy)
                && Objects.equals(this.skip, getVdsesRequestBody.skip)
                && Objects.equals(this.where, getVdsesRequestBody.where);
    }
