...
public class VmEjectCdRomParams extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VmEjectCdRomParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public VmEjectCdRomParams where_ExplictlyNonNull() {
