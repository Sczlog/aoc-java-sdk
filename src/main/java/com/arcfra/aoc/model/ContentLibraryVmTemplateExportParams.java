...
public class ContentLibraryVmTemplateExportParams
    ...
    public ContentLibraryVmTemplateExportParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public ContentLibraryVmTemplateExportParams where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        ContentLibraryVmTemplateExportParams contentLibraryVmTemplateExportParams =
                (ContentLibraryVmTemplateExportParams) o;
