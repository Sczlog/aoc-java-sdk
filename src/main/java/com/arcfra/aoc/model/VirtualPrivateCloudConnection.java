...
public class VirtualPrivateCloudConnection
    ...
    public VirtualPrivateCloudConnection aggregate_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AGGREGATE);
        return this;
    }

    public VirtualPrivateCloudConnection aggregate_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        VirtualPrivateCloudConnection virtualPrivateCloudConnection =
                (VirtualPrivateCloudConnection) o;
