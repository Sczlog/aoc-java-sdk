...
public class WithTaskIscsiTarget
    ...
    public WithTaskIscsiTarget taskId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_TASK_ID);
        return this;
    }

    public WithTaskIscsiTarget taskId_ExplictlyNonNull() {
    ...
    public WithTaskIscsiTarget data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public WithTaskIscsiTarget data_ExplictlyNonNull() {
