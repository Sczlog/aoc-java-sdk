...
public class GetUserRoleNextsRequestBody
    ...
    public GetUserRoleNextsRequestBody() {}
    ...
    public GetUserRoleNextsRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetUserRoleNextsRequestBody after_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetUserRoleNextsRequestBody before_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsRequestBody first(Integer first) {
    ...
    public GetUserRoleNextsRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetUserRoleNextsRequestBody first_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsRequestBody last(Integer last) {
    ...
    public GetUserRoleNextsRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetUserRoleNextsRequestBody last_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetUserRoleNextsRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsRequestBody skip(Integer skip) {
    ...
    public GetUserRoleNextsRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetUserRoleNextsRequestBody skip_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetUserRoleNextsRequestBody where_ExplictlyNonNull() {
