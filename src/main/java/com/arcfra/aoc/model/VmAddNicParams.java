...
public class VmAddNicParams extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VmAddNicParams data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public VmAddNicParams data_ExplictlyNonNull() {
    ...
    public VmAddNicParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public VmAddNicParams where_ExplictlyNonNull() {
