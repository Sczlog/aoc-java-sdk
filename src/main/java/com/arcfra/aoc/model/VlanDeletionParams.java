...
public class VlanDeletionParams extends com.arcfra.aoc.ConditionalNullable.ConditionalNullablePojo {
    ...
    public VlanDeletionParams where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public VlanDeletionParams where_ExplictlyNonNull() {
