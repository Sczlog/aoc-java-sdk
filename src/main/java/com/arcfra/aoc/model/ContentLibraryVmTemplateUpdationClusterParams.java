...
public class ContentLibraryVmTemplateUpdationClusterParams
    ...
    public ContentLibraryVmTemplateUpdationClusterParams data(
            ContentLibraryVmTemplateUpdationClusterParamsData data) {
    ...
    public ContentLibraryVmTemplateUpdationClusterParams where(
    ...
    public boolean equals(Object o) {
        ...
        ContentLibraryVmTemplateUpdationClusterParams
                contentLibraryVmTemplateUpdationClusterParams =
                        (ContentLibraryVmTemplateUpdationClusterParams) o;
