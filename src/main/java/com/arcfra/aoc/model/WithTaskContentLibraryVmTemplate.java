...
public class WithTaskContentLibraryVmTemplate
    ...
    public WithTaskContentLibraryVmTemplate taskId_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_TASK_ID);
        return this;
    }

    public WithTaskContentLibraryVmTemplate taskId_ExplictlyNonNull() {
    ...
    public WithTaskContentLibraryVmTemplate data_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_DATA);
        return this;
    }

    public WithTaskContentLibraryVmTemplate data_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        WithTaskContentLibraryVmTemplate withTaskContentLibraryVmTemplate =
                (WithTaskContentLibraryVmTemplate) o;
