...
public class GetVmTemplatesRequestBody
    ...
    public GetVmTemplatesRequestBody() {}

    public GetVmTemplatesRequestBody after(String after) {
    ...
    public GetVmTemplatesRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetVmTemplatesRequestBody after_ExplictlyNonNull() {
    ...
    public GetVmTemplatesRequestBody before(String before) {
    ...
    public GetVmTemplatesRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetVmTemplatesRequestBody before_ExplictlyNonNull() {
    ...
    public GetVmTemplatesRequestBody first(Integer first) {
    ...
    public GetVmTemplatesRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetVmTemplatesRequestBody first_ExplictlyNonNull() {
    ...
    public GetVmTemplatesRequestBody last(Integer last) {
    ...
    public GetVmTemplatesRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetVmTemplatesRequestBody last_ExplictlyNonNull() {
    ...
    public GetVmTemplatesRequestBody orderBy(VmTemplateOrderByInput orderBy) {
    ...
    public GetVmTemplatesRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetVmTemplatesRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetVmTemplatesRequestBody skip(Integer skip) {
    ...
    public GetVmTemplatesRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetVmTemplatesRequestBody skip_ExplictlyNonNull() {
    ...
    public GetVmTemplatesRequestBody where(VmTemplateWhereInput where) {
    ...
    public GetVmTemplatesRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetVmTemplatesRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetVmTemplatesRequestBody getVmTemplatesRequestBody = (GetVmTemplatesRequestBody) o;
        return Objects.equals(this.after, getVmTemplatesRequestBody.after)
                && Objects.equals(this.before, getVmTemplatesRequestBody.before)
                && Objects.equals(this.first, getVmTemplatesRequestBody.first)
                && Objects.equals(this.last, getVmTemplatesRequestBody.last)
                && Objects.equals(this.orderBy, getVmTemplatesRequestBody.orderBy)
                && Objects.equals(this.skip, getVmTemplatesRequestBody.skip)
                && Objects.equals(this.where, getVmTemplatesRequestBody.where);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetVmTemplatesRequestBody {\n");
