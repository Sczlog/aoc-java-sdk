...
public class GetUserRoleNextsConnectionRequestBody
    ...
    public GetUserRoleNextsConnectionRequestBody after_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_AFTER);
        return this;
    }

    public GetUserRoleNextsConnectionRequestBody after_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsConnectionRequestBody before_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_BEFORE);
        return this;
    }

    public GetUserRoleNextsConnectionRequestBody before_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsConnectionRequestBody first_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_FIRST);
        return this;
    }

    public GetUserRoleNextsConnectionRequestBody first_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsConnectionRequestBody last_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_LAST);
        return this;
    }

    public GetUserRoleNextsConnectionRequestBody last_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsConnectionRequestBody orderBy_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_ORDER_BY);
        return this;
    }

    public GetUserRoleNextsConnectionRequestBody orderBy_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsConnectionRequestBody skip_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_SKIP);
        return this;
    }

    public GetUserRoleNextsConnectionRequestBody skip_ExplictlyNonNull() {
    ...
    public GetUserRoleNextsConnectionRequestBody where_ExplictlyNull() {
        this._isPresent_.add(SERIALIZED_NAME_WHERE);
        return this;
    }

    public GetUserRoleNextsConnectionRequestBody where_ExplictlyNonNull() {
    ...
    public boolean equals(Object o) {
        ...
        GetUserRoleNextsConnectionRequestBody getUserRoleNextsConnectionRequestBody =
                (GetUserRoleNextsConnectionRequestBody) o;
